...
public class RAM_512x16Test {
    @Test(expected = IllegalArgumentException.class)
    public void checkInvalidAddress() throws Exception {
        RAM_512x16 ram = new RAM_512x16();
    ...
    public void checkRam() throws Exception {
        ...
        boolean[] addr1 = Converter.convertToBooleans(new int[]{0,0,0,0,0,0,0,0,0});
        boolean[] addr2 = Converter.convertToBooleans(new int[]{0,0,1,0,0,1,0,1,0});
        boolean[] addr3 = Converter.convertToBooleans(new int[]{0,1,0,0,1,0,1,0,0});
        boolean[] addr4 = Converter.convertToBooleans(new int[]{0,1,1,0,1,1,1,1,0});
        boolean[] addr5 = Converter.convertToBooleans(new int[]{1,0,0,1,0,0,0,0,1});
        boolean[] addr6 = Converter.convertToBooleans(new int[]{1,0,1,1,0,1,0,1,1});
        boolean[] addr7 = Converter.convertToBooleans(new int[]{1,1,0,1,1,0,1,0,1});
        boolean[] addr8 = Converter.convertToBooleans(new int[]{1,1,1,1,1,1,1,1,1});
        ram.address(addr1);
