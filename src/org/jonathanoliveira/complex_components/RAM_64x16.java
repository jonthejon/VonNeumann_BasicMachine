...
/**
 * Ram chip.
 * This chip stores 64 different 16bit values
 */
public class RAM_64x16 {
    ...
    public RAM_64x16() {
        this.bitSize = 16;
        this.numRams = 8;
        this.address = new boolean[6];
        this.rams = new RAM_8x16[numRams];
        for (int i = 0; i < numRams; i++) {
            this.rams[i] = new RAM_8x16();
        }
    ...
    private void wire() {
        ...
        boolean[] lowAddress = new boolean[]{address[3], address[4], address[5]};
