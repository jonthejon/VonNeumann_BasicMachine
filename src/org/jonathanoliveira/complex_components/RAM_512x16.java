...
/**
 * Ram chip.
 * This chip stores 512 different 16bit values
 */
public class RAM_512x16 {
    private int bitSize;
    private int numRams;
    ...
    public RAM_512x16() {
        this.bitSize = 16;
        this.numRams = 8;
        this.address = new boolean[9];
        this.rams = new RAM_64x16[numRams];
        for (int i = 0; i < numRams; i++) {
            this.rams[i] = new RAM_64x16();
        }
    ...
    private void wire() {
        ...
        boolean[] lowAddress = new boolean[]{address[3], address[4], address[5], address[6], address[7], address[8]};
